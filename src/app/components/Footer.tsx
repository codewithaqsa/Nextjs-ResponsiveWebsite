    ...
    <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
      ...
      <div className="lg:w-1/4 md:w-1/2 w-full px-4">
        ...
        <nav className="list-none mb-10">
          ...
          <li>
            <a className="text-gray-600 hover:text-gray-800">Dicounts</a>
          </li>
          <li>
      ...
      <div className="lg:w-1/4 md:w-1/2 w-full px-4">
        ...
        <nav className="list-none mb-10">
          ...
          <li>
            <a className="text-gray-600 hover:text-gray-800">Browse the Shpo</a>
          </li>
          <li>
            <a className="text-gray-600 hover:text-gray-800">Categroy</a>
          </li>
          <li>
            <a className="text-gray-600 hover:text-gray-800">Pre-Bulid Pages</a>
          </li>
          <li>
            <a className="text-gray-600 hover:text-gray-800">Visual Copmoser Element</a>
          </li>
          <li>
